...
public:
  ...
  UDPForwarder *getUdpForwarder() const { return udpForwarder_; }
  void setUdpForwarder(UDPForwarder *forwarder) { udpForwarder_ = forwarder; }
...
private:
  ...
  UDPForwarder *udpForwarder_ = nullptr;
